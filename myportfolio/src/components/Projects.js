...
const Projects = () => {
  return (
    <section id="projects" className='mb-16 hidden md:flex'>
           


            <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
                {/* <!--heading--> */}
                <h2 class="text-5xl font-bold text-center">Worked Projects</h2>

                <div class="flex flex-col mt-24 md:flex-row md:space-x-6">

                    
                
                    <div class="flex flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:w-1/4">
...
used throughout.</p>
                    ...
                    <div class="hidden md:flex flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:w-1/4">
